...
public class RSABlocks {
    ...
    public static void register() {
        ...
        BLOCKS.register(ID_FLUX_PATH, () -> new GrassPathBlock(AbstractBlock.Properties.of(Material.DIRT).strength(0.65F).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).isViewBlocking((a, b, c) -> true).isSuffocating((a, b, c) -> true).speedFactor(1.15F)));
    }
