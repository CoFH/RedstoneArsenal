...
public class RSAEntities {
    ...
    public static void register() {
        ...
        ENTITIES.register(ID_FLUX_ARROW, () -> EntityType.Builder.<FluxArrowEntity>of(FluxArrowEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).fireImmune().build(ID_FLUX_ARROW));
